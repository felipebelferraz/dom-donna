          ...
          <div style={{paddingBottom:24}}>
            ...
            <div style={{padding:"0 16px",display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
              ...
              <div onClick={()=>setActiveTab("shopping")} style={{background:B.bgCard,border:`1px solid ${B.border}`,borderRadius:20,padding:18,cursor:"pointer",transition:"all .2s"}}>
                ...
                <div style={{fontSize:11,color:B.textMuted}}>{shoppingLists.length} lista(s)</div>
              </div>
              <div onClick={()=>setActiveTab("health")} style={{background:B.bgCard,border:`1px solid ${B.border}`,borderRadius:20,padding:18,cursor:"pointer",transition:"all .2s"}}>
                <div style={{width:38,height:38,borderRadius:11,background:"rgba(248,113,113,.1)",border:"1px solid rgba(248,113,113,.2)",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:10}}><Icon d={ic.heart} size={17} stroke={B.danger}/></div>
                <div style={{fontSize:13,fontWeight:800,color:B.white,marginBottom:3}}>Saúde</div>
                <div style={{fontSize:11,color:B.textMuted}}>{healthItems.filter(h=>!h.done).length} pendente(s)</div>
              </div>
              <div onClick={()=>setActiveTab("notes")} style={{background:B.bgCard,border:`1px solid ${B.border}`,borderRadius:20,padding:18,cursor:"pointer",transition:"all .2s"}}>
                <div style={{width:38,height:38,borderRadius:11,background:"rgba(52,211,153,.1)",border:"1px solid rgba(52,211,153,.2)",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:10}}><Icon d={ic.filetext} size={17} stroke="#34d399"/></div>
        ...
        {activeTab==="agenda"&&(
          <div style={{paddingBottom:24}}>
            <div style={{padding:"12px 20px 8px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div style={{fontSize:16,fontWeight:800,color:B.white}}>{MONTHS_FULL[selMonth]} {selYear}</div>
